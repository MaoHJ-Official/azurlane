...
class leidian:
    ...
    def autoSP4(self, name):
        if name == '':
            print('---------------------------emulator name error')
            exit(1)

        # mSP4.png
        ipath = os.path.abspath('.') + '\mal_script\SP4\images\mSP4.png'
        cen = leidian.recognize(self, name, ipath, 15, 'SP4')
        if not cen:
            exit(1)
        leidian.m_tap(self, cen[0], cen[1], name)

        # mImmediateStart.png
        ipath = os.path.abspath('.') + '\mal_script\SP4\images\mImmediateStart.png'
        ...
        # mCollate.png
        ipath = os.path.abspath('.') + '\mal_script\SP4\images\mCollate.png'
        cen = leidian.recognize(self, name, ipath, 5, '整理')
        if cen:
            leidian.m_tap(self, cen[0], cen[1], name)

            # mRetire.png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mRetire.png'
            ...
            # mInform.png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mInform.png'
            cen = leidian.recognize(self, name, ipath, 15, '信息')
            if not cen:
                exit(1)

            # mConfirm .png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mConfirm.png'
            ...
            # mGetitems.png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mGetitems.png'
            ...
            # mMaterials.png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mMaterials.png'
            ...
            # mCancel.png
            ipath = os.path.abspath('.') + '\mal_script\SP4\images\mCancel.png'
        ...
        # elite * 2 + elite * 1
        eliteRelativePosition = [[460, 740], [555, 600], [750, 600], [845, 760]]
        for j in range(2):
            for i in range(4):
                ...
                if cen:
                    ...
                    # mOffensive.png
                    ipath = os.path.abspath('.') + '\mal_script\SP4\images\mOffensive.png'
                ...
                if not cen:
                    ...
                    # mContinue.png
                    ipath = os.path.abspath('.') + '\mal_script\SP4\images\mContinue.png'
                    ...
                    # mConfirm_gold.png
                    ipath = os.path.abspath('.') + '\mal_script\SP4\images\mConfirm_gold.png'
        ...
        for i in range(2):
            ...
            time.sleep(20)
            # mEnemy1.png
            ipath1 = os.path.abspath('.') + '\mal_script\SP4\images\m3.png'
            cen1 = leidian.recognize(self, name, ipath1, 5, '敌舰1：三星')

            # mEnemy2.png
            ipath2 = os.path.abspath('.') + '\mal_script\SP4\images\m2.png'
            cen2 = leidian.recognize(self, name, ipath2, 5, '敌舰2：二星')

            # mEnemy3.png
            ipath3 = os.path.abspath('.') + '\mal_script\SP4\images\m1.png'
        ...
        time.sleep(10)
        # m80.png
        ipath = os.path.abspath('.') + '\mal_script\SP4\images\m80.png'

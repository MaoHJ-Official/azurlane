...
class leidian:
    ...
    def autoSP5(self, name):
        if name == '':
            print('---------------------------emulator name error')
            exit(1)

        # mSP5.png
        ipath = os.path.abspath('.') + '\mal_script\SP5\images\mSP5.png'
        cen = leidian.recognize(self, name, ipath, 15, 'SP5')
        if not cen:
            exit(1)
        leidian.m_tap(self, cen[0], cen[1], name)

        # mImmediateStart.png
        ipath = os.path.abspath('.') + '\mal_script\SP5\images\mImmediateStart.png'
        ...
        # mCollate.png
        ipath = os.path.abspath('.') + '\mal_script\SP5\images\mCollate.png'
        cen = leidian.recognize(self, name, ipath, 5, '整理')
        if cen:
            leidian.m_tap(self, cen[0], cen[1], name)

            # mRetire.png
            ipath = os.path.abspath('.') + '\mal_script\SP5\images\mRetire.png'
            ...
            # mInform.png
            ipath = os.path.abspath('.') + '\mal_script\SP5\images\mInform.png'
            ...
            # mGetitems.png
            ipath = os.path.abspath('.') + '\mal_script\SP5\images\mGetitems.png'
            ...
            # mMaterials.png
            ipath = os.path.abspath('.') + '\mal_script\SP5\images\mMaterials.png'
            ...
            # mCancel.png
            ipath = os.path.abspath('.') + '\mal_script\SP5\images\mCancel.png'
        ...
        # elite * 2 + elite * 1
        eliteRelativePosition = [[490, 605], [490, 475], [850, 475], [850, 605]]
        for j in range(2):
            for i in range(4):
                ...
                if cen:
                    ...
                    # mOffensive.png
                    ipath = os.path.abspath('.') + '\mal_script\SP5\images\mOffensive.png'
                ...
                if not cen:
                    ...
                    # mContinue.png
                    ipath = os.path.abspath('.') + '\mal_script\SP5\images\mContinue.png'
                    ...
                    # mConfirm_gold.png
                    ipath = os.path.abspath('.') + '\mal_script\SP5\images\mConfirm_gold.png'
        ...
        for i in range(3):
            ...
            time.sleep(10)
            # mEnemy1.png
            ipath1 = os.path.abspath('.') + '\mal_script\SP5\images\m77.png'
            cen1 = leidian.recognize(self, name, ipath1, 5, '敌舰1：三星Lv77')

            # mEnemy2.png
            ipath2 = os.path.abspath('.') + '\mal_script\SP5\images\m76.png'
            cen2 = leidian.recognize(self, name, ipath2, 5, '敌舰2：二星Lv76')

            # mEnemy3.png
            ipath3 = os.path.abspath('.') + '\mal_script\SP5\images\m75.png'
            cen3 = leidian.recognize(self, name, ipath3, 5, '敌舰3：一星Lv75')
        ...
        time.sleep(10)
        # m80.png
        ipath = os.path.abspath('.') + '\mal_script\SP5\images\m80.png'
        cen = leidian.recognize(self, name, ipath, 15, '敌方旗舰：Lv80')
        if not cen:
            exit(1)
        leidian.m_tap(self, cen[0], cen[1], name)
        ...
        print('---------------------------wait 135s for weigh anchor')
        time.sleep(135)  # 战斗时长
